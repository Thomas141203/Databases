...
INSERT INTO ETUDIANT VALUES ((SELECT nvl(MAX(numEtu), 0) + 1 FROM ETUDIANT), 'Fourier', 'Joseph', NULL, NULL);

INSERT INTO INSCRIPTION VALUES (1, 1, '01-SEP-2023');

INSERT INTO EXAMEN VALUES(
	(SELECT codMod FROM MODULE WHERE nomMod = 'Oracle'),1, to_date('11012024','ddmmyyyy')
);
...
-- Pour tester la contraine numéro 2
SELECT * FROM MODULE;
